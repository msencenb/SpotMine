...
/* ====== ACCORDION ====== */
$('.accordion-holder header').click(function() {

	$('.accordion-holder header').removeClass('acdn_on');
	$('.accordion-holder article').slideUp('normal');
...
$('.accordion-holder header').mouseover(function() {
